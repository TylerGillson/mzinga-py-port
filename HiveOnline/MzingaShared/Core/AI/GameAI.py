    ...
    def calculate_board_score(self, game_board, board_metrics=None, start_weights=None, end_weights=None):
        if game_board:
            ...
            for piece_name in EnumUtils.PieceNames:
                ...
                score += colour_value * get(bug_type, "InPlayWeight") * board_metrics[piece_name].InPlay
                score += colour_value * get(bug_type, "IsPinnedWeight") * board_metrics[piece_name].IsPinned
                score += colour_value * get(bug_type, "IsCoveredWeight") * board_metrics[piece_name].IsCovered
